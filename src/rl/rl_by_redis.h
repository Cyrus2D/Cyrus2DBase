...
public:
    ...
    void send_player_request(int num, long cycle, vector<double> features);
    std::vector<double> get_player_response(int num, long cycle);
    void send_trainer_reward(int num, long cycle, vector<double> done_rewards) const;
